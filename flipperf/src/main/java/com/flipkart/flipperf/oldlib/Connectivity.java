...
/**
 * Created by anirudh.r on 09/06/16 at 1:05 PM.
 * copied from older batchnetworking
 */
public class Connectivity {

    public enum Connection {
        NO_CONNECTIVITY("no_connection"), MOBILE("mobile"), WIFI("wifi");
        private String name;
    ...
    public enum ConnectionSpeed {
        NO_CONNECTIVITY("no_connection"), SLOW("slow"), FAST("fast");
        private String name;
